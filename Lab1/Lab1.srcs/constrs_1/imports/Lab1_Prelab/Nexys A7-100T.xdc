...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { swop }]; #IO_L24N_T3_34 Sch=sw[8]
...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { ledcout }]; #IO_L7P_T1_D09_14 Sch=led[4]
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { ledov }]; #IO_L18N_T2_A11_D27_14 Sch=led[5]
