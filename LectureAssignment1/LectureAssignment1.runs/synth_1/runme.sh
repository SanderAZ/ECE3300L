...
HD_PWD='D:/Users/Sander/Documents/GitHub/ECE3300L/LectureAssignment1/LectureAssignment1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signedmultiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signedmultiplier.tcl
